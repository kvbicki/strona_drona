...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators }) {
  ...
  return (
    <motion.div onClick={handleClick} className="step-indicator" animate={status} initial={false}>
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: "#83A8D3", color: "#83A8D3" },
          active: { scale: 1, backgroundColor: "#83A8D3", color: "#83A8D3" },
          complete: { scale: 1, backgroundColor: "##83A8D3", color: "##83A8D3" },
        }}
